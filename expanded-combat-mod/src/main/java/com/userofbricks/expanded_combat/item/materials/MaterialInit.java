...
public class MaterialInit {
    ...
    public static List<com.userofbricks.expanded_combat.api.registry.ShieldToMaterials> shieldToMaterialsList = new ArrayList<>();
    ...
    public static Material getMaterialForShieldPart(String part, ItemLike shield) {
        for (com.userofbricks.expanded_combat.api.registry.ShieldToMaterials shieldToMaterials : shieldToMaterialsList) {
