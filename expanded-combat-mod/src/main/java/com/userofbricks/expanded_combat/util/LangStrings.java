...
public class LangStrings {
    ...
    public static String getOrCreateCategoryForField(Field field, List<String> alreadyAddedStrings, String configLangStart) {
    ...
    public static void ifNotExcludedRegisterLangs(Field field, String configLangStart, List<String> alreadyAddedStrings) {
